        ...
        <Header />
          <Container>
              <Switch>
                  ...
                  <Route path="/posts/add" exact render={(props) => <AddQuote {...props} />}/>
                  <Route path="/posts/:id" exact render={(props) => <FullQuote {...props}/>}/>
                  <Route path="/posts/:id/edit"  render={(props) => <EditQuote {...props} />}/>
